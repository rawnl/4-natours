...
var displayMap = function displayMap(locations) {
  var map = new maplibregl.Map({
    container: 'map',
    style: 'https://api.maptiler.com/maps/7ee1218e-447f-478d-bc13-c9d96eec3265/style.json?key=Jrlz1iNQ4PQwTgqz3zK5',
    // 'https://demotiles.maplibre.org/style.json', // 'https://api.maptiler.com/maps/7ee1218e-447f-478d-bc13-c9d96eec3265/style.json?key=Jrlz1iNQ4PQwTgqz3zK5', // stylesheet location
    scrollZoom: false,
    center: [0, 0]
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
// DOM elements
var mapLibre = document.getElementById('map');
...
// Delegation
if (mapLibre) {
  var locations = JSON.parse(mapLibre.dataset.locations);
